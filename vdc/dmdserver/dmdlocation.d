...
nothrow:
	...
	*/
	...
	extern (D) uint charnum() const @nogc @safe @property
	{
		return data & 0xffff;
	}

	/// line number, starting from 1
	extern (D) uint linnum() const @nogc @trusted @property
	{
	...
	*/
	extern (D) const(char)* filename() const @nogc @property
	{
	...
	bool isValid() const pure @safe @property
	{
		return data != 0;
	}
